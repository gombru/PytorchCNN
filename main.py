...
split_train = 'city_classification_gt/cities_instagram/trainCitiesClassification'
split_val =  'city_classification_gt/cities_instagram/valCitiesClassification'
arch = 'resnet18'
workers = 4 # Num of data loading workers
epochs = 90
start_epoch = 0 # Useful on restarts
batch_size = 12 #256 # Batch size
...
def main():
    ...
    try_dataset = datasets.ImageFolder(
        '/home/raulgomez/imsample/',
        transforms.Compose([
    ...
    val_loader_b = torch.utils.data.DataLoader(
        try_dataset, batch_size=batch_size, shuffle=False, num_workers=workers, pin_memory=True)

    if evaluate:
        validate(val_loader_b, model, criterion)
